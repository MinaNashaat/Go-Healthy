...
import com.example.gohealthy.dialogs.ExerciseSelectionDialog
import com.example.gohealthy.dialogs.MealSelectionDialog
...
class HomePageFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      binding.addMealBTN.setOnClickListener {
        MealSelectionDialog().show(parentFragmentManager, "meal_dialog")
      }


      binding.addExerciseBTN.setOnClickListener {
        ExerciseSelectionDialog().show(parentFragmentManager, "exercise_dialog")
      }
