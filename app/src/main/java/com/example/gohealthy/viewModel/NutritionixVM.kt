...
class NutritionixVM:ViewModel() {
    ...
    fun addManualMeal(calories: Int, context: Context) {
      _caloriesIn += calories
      prefManager.saveCaloriesIn(_caloriesIn.toInt())
      _totalCal.postValue((_caloriesIn - _caloriesOut).toInt())
    }

    fun addManualExercise(calories: Int, context: Context) {
      _caloriesOut += calories
      prefManager.saveCaloriesOut(_caloriesOut)
      _totalCal.postValue((_caloriesIn - _caloriesOut).toInt())
    }
